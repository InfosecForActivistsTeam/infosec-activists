...
If neither of the above options are available for your service, you might be able to use your email or phone (via SMS) to receive one-time codes. These are not as secure as the above options but, as stated above, any 2FS is worlds better than none at all.
