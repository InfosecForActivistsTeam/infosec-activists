...
## Tools NOT to Use
In this document, we make recommendations against some popular & commonplace tools. Our recommendations
...
Another popular tool we must recommend against is Telegram as it has a track record of
[security issues](https://www.wired.com/story/telegram-encryption-whatsapp-settings/). While it
supports end-to-end encryption (see [Messaging with Encryption](#messaging-with-encryption), below)
