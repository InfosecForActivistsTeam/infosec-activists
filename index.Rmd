...
typically involve drawing a shape or entering a code. **Entering a code is the most secure**, as the
shape can be traced from fingerprints on the screen. The code should be long enough to
prevent your fingerprints from giving it away. Related, you want your screen to lock
...
start a meeting directly from their webpage at [meet.jit.si](https://meet.jit.si/). No
...
can use physical tokens to generate one-time codes.
...
and the ACLU tackles [ongoing threats to protestors' rights](https://www.aclu.org/podcast/deray-mckesson-threat-protesters-rights-ep-99).
