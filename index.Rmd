...
supports end-to-end encryption for messages between individuals (see [Messaging with Encryption](#messaging-with-encryption) below), it does not apply this security to group messages. Group
messages can be flagged as “spam” or “abuse” by Telegram staff and contractors, which means that
...
## After
* Leave and delete Signal groups set up for that protest. (The last one to leave burns the group.)
