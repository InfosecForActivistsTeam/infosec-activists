---
title: "DRAFT Infosec for Activists DRAFT"
...
The United States has a strong tradition of activism, dating back to the Boston Tea Party.  Today, activism in the US remains important and necessary. That being said, challenging existing power structures carries [an element of risk](https://www.aclu.org/issues/free-speech/rights-protesters/anti-protest-bills-around-country ); and your [personal information](https://www.businessinsider.com/fbi-uses-instagram-etsy-linkedin-to-find-george-floyd-protester-2020-6) is easier to access than it has ever been in the past. In this document, we’ll talk about how hostile groups can leverage information against activists, and what you can do to protect yourself and others.  
...
Assume the police have access to anything you send or receive. Assume that any SMS messages you send, or phone calls that you make, can be logged & recorded. If your information is strongly encrypted, they may still have it, but can’t decrypt it. Be sure to update your phone to the latest supported OS well before the time and date of the action. For 2020, this would be iOS 14 and Android 11.


If you have privacy concerns and your phone is no longer receiving software updates, consider not bringing the device. If you are attending a protest without a phone, don’t go alone. Arrange times and places where you can meet up with your buddies, before you go to the protest.
...
* Make sure your device is updated to the latest version of your OS, and all your apps are up to date.
  * Not running the latest available OS version could expose you to security vulnerabilities which may have been fixed in later releases.
...
* Find a friend (or several!) to go with and connect over Signal to discuss plans.
  * For an added layer of security, enable “[Disappearing Messages](https://support.signal.org/hc/en-us/articles/360007320771-Set-and-manage-disappearing-messages)” for the group.
...
# Maps
| Service         | Grade | Comments                                                                                                                                               |
|-----------------|-------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Apple Maps](https://maps.apple.com/go)      | A     | Apple’s logs randomize identity. The data on your phone is not randomized, so use secure backups. See “Maps”   https://www.apple.com/privacy/features/ |
| [DuckDuckGo Maps](https://duckduckgo.com/) | A     | DuckDuckGo’s mapping service uses Apple Maps and is further anonymized.                                                                                |
| [OsmAnd](https://osmand.net/)          | B     | May collect and store user information and history.                                                                                                    |
| Sygic           | F     | Logs and stores all activity in full detail and claim they can use it for anything.                                                                    |
| Google Maps     | F     | Logs and stores all activity in full detail by default. Disallows your phone from being offline while giving directions.                               |

# Preparing your Phone
## iPhone Setup
The below steps will provide you increasing levels of privacy but will have more impact on your normal usage. As a minimum, I would recommend performing all the steps through disabling Touch ID & Face ID. As you go further down the list, there will be diminishing returns except for particular situations (for example, if your device is confiscated during an arrest).
...
## Android Setup
**If you have an older-model android** you should turn on full-device encryption. This paragraph impacts phones that were [made around 2016](https://www.computerworld.com/article/2995437/google-makes-full-disk-encryption-and-secure-boot-mandatory-for-some-android-60-devices.html) or earlier, but it’s worth a check even if your phone isn’t that old. **Go to Settings, choose Security, and find the Encrypt Phone option.** It will say “Encrypted” or prompt you to turn on encryption. Turning on encryption will take a few hours, and it will need to be plugged in to its charger to do it. You only need to do this once.

**In Security settings:**

**Lock your phone with a PIN or Password.** [Do not use a Swipe, Pattern, or fingerprint reader.](https://www.wired.co.uk/article/phone-lock-screen-password) When you set up the screen lock, it will ask if you want notifications to be shown on screen while the phone is locked. The safest option is “**Don’t show any notifications at all.**” If that is unacceptable to you, choose “Hide sensitive notification content.”
...
* You can turn mobile data back on without leaving airplane mode if you need it.

# Security Ideas
This section is about keeping your information private while you live your life. In this document, “private” means only accessible to you, and not accessible by companies, law enforcement, or other entities, without your permission.
...
Here are some of the more popular messaging apps, with grades based on their security.

# Password Safety

The password is the primary mechanism used to secure your online accounts, but it is also a significant point of vulnerability.  How can we resolve this? 
...
+-------+----------------------------------------------------+
| A+ 	| An authenticator app, such as Google Authenticator |
+-------+----------------------------------------------------+
| A 	| A token key, such as the Yubikey. This device plugs into your computer or can be tapped to your phone whenever you need to confirm. Extremely secure, but not as well-supported as an authenticator app. |
+-------+----------------------------------------------------+
| B 	| Email one-time-use codes. Easy, but not as secure as the above options. |
+-------+----------------------------------------------------+
| D 	| Text Message one-time-use codes. This is not very secure, but it is better than nothing. Only choose this if no other option is available. |
+-------+----------------------------------------------------+
...
Your passwords should be **easy for you to remember, but take too long for a hacker to guess.** The best technique right now is to use a passphrase of multiple words that are easy for you to remember, but so long that it would take centuries for a hacker to crack. You can use a technique called Diceware to come up with a random, but memorable passphrase. Someone even built a nice online tool for you, below.
...
When you respond to security questions, try **use code phrases instead of answering them honestly**, so that nobody familiar with your life could guess it and force a password reset without your consent. For instance, for the question “Where did you attend school in the sixth grade?” you could instead respond with your favorite cartoon character from the sixth grade.  
