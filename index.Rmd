...
has a **GPS** receiver built into it that enables maps and other location-based apps to work.
...
[Anything in the backup](https://oleb.net/2020/icloud-end-to-end-encryption/), which may include 
photos, contacts, and unencrypted messages, can be handed over to law enforcement. Keys to unlock 
the phone's full-disk encryption are also stored in the iCloud backup. This arrangement allows law 
enforcement to request the backup data from Apple and use the key to unlock the entire phone. It 
also offers a convenience, where if the user forgets their unlock code, Apple can still recover the 
device. For activists, the risk posed by your unlock keys being accessible to law enforcement is 
potentially greater than the benefits of that convenience. 
Therefore we **do not recommend using cloud backups.**
